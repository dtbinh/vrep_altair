...
void CBrowser::setRenderingSizeAndPosition(int xSize,int ySize,int xPos,int yPos)
{
	...
	if (_dirBrowserHeight<240)//HIERARCHY_SCROLLBAR_WIDTH*3)
		_dirBrowserHeight=240;//HIERARCHY_SCROLLBAR_WIDTH*3;
	if (_dirBrowserHeight>renderingSize[1]-160)
		_dirBrowserHeight=renderingSize[1]-160;
