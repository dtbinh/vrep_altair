...
int _simAttachDirtyTexture(lua_State* L);
...
static SLuaCommands simLuaCommands[]= 
{
	...
	{"simGetJointTargetVelocity",_simGetJointTargetVelocity,"number result,number targetVelocity=simGetJointTargetVelocity(number objectHandle)"},
	...
	{"simJointGetForce",_simJointGetForce,"number forceOrTorque=simJointGetForce(number jointHandle)"},
	...
	{"simGetMpConfigForTipPose",_simGetMpConfigForTipPose,"number trialsBeforeSuccess,table jointPositions=simGetMpConfigForTipPose(number motionPlanningObjectHandle,number options,\nnumber closeNodesDistance,number trialCount,table_7 tipPose,number maxTimeInMs=0,table referenceConfigs=nil,table jointWeights=nil,table jointBehaviour=nil,number correctionPasses=0)"},
	{"simFindMpPath",_simFindMpPath,"table path,table lengths,table tipPositions=simFindMpPath(number motionPlanningObjectHandle,table startConfig,table goalConfig,\nnumber options,number stepSize,number maxTimeInMs=0,table auxIntParams=nil,table auxFloatParams=nil)"},
	...
	{"simRMLPosition",_simRMLPosition,"number result,table newPosVelAccel,number synchronizationTime=simRMLPosition(number dofs,number timeStep,number flags,table currentPosVelAccel,table maxVelAccelJerk,table selection,table targetPosVel)"},
	{"simRMLVelocity",_simRMLVelocity,"number result,table newPosVelAccel,number synchronizationTime=simRMLVelocity(number dofs,number timeStep,number flags,table currentPosVelAccel,table maxAccelJerk,table selection,table targetVel)"},
    ...
    {"simAttachDirtyTexture", _simAttachDirtyTexture, "number result=simAttachDirtyTexture(number objHandle, string filename)"},
