...
{
	return(simJointGetForce_internal(jointHandle,forceOrTorque));
}
...
//extensions
VREP_DLLEXPORT simInt simAttachDirtyTexture(simInt objHandle, simChar * filename)
{
    return(simAttachDirtyTexture_internal(objHandle, filename));
}
