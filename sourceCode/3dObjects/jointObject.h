...
public:
	...
	void setEnableDynamicMotorPositionControl(bool p);
	bool getEnableDynamicMotorPositionControl();
...
protected:
	...
	bool _initialDynamicMotorPositionControl;
	...
	bool _dynamicMotorPositionControl;
