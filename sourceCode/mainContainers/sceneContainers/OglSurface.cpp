...
int COglSurface::_browserWidth=128+2+4+HIERARCHY_SCROLLBAR_WIDTH;
...
{ // NOT FULLY IMPLEMENTED! objType=-1 --> not supported, 0 --> hierarchy, 1 --> 3DViewable
	...
	{
		VPoint btl(offx+_hierarchyWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
...
bool COglSurface::leftMouseButtonDown(int x,int y,int selectionStatus)
{
	...
	if (isBrowserEffectivelyVisible())
	{
		VPoint btl(offx+_browserWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
...
void COglSurface::mouseMove(int x,int y,bool passiveAndFocused)
{
	...
	if (isBrowserEffectivelyVisible())
	{
		VPoint btl(_browserWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
	...
	if (_hierarchyEnabled)
	{
		...
		if (isBrowserEffectivelyVisible())
			b=_browserWidth;
		VPoint btl(b+_hierarchyWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
...
void COglSurface::render(int currentCursor,int mouseButtonState,int mousePos[2])
{
	...
	else
	{
		...
		if (_hierarchyEnabled)
		{
			...
			VPoint size(_hierarchyWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
			...
			pos.x=b+_hierarchyWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH/2-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH;
			size.x=BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH;
			...
			glLineWidth(1.0f);
			glBegin(GL_LINES);
			glVertex3i(b,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1,0);
			glVertex3i(b+_hierarchyWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1,0);
			glEnd();
			glLineWidth(1.0f);
		...
		if (isBrowserEffectivelyVisible())
		{
			...
			float txtCol[3]={0.2f,0.2f,0.2f};
			float* bkgrndCol=ogl::TITLE_BAR_COLOR;
			VPoint size(_browserWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,BROWSER_HIERARCHY_TITLE_BAR_HEIGHT);
			...
			pos.x=_browserWidth-BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH/2-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH;
			size.x=BROWSER_HIERARCHY_TITLE_BAR_CLOSING_BUTTON_WIDTH;
			float* bkgrndCol2=ogl::TITLE_BAR_BUTTON_COLOR;
			buttonAttrib=sim_buttonproperty_button|sim_buttonproperty_enabled|sim_buttonproperty_horizontallycentered|sim_buttonproperty_verticallycentered;
			if (_browserClosingButtonDown)
			...
			glLineWidth(1.0f);
			glBegin(GL_LINES);
			glVertex3i(0+0,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1,0);
			glVertex3i(0+_browserWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1,0);
			glEnd();
			glLineWidth(1.0f);
...
void COglSurface::setHierarchySurfaceSizeAndPosition()
{
	...
	if (_hierarchyEnabled)
	{
		...
		if (_hierarchyWidth<128+2+4+HIERARCHY_SCROLLBAR_WIDTH)
			_hierarchyWidth=128+2+4+HIERARCHY_SCROLLBAR_WIDTH;
		App::ct->hierarchy->setRenderingSizeAndPosition(_hierarchyWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH+1,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1-1,surfacePosition[0]+b,surfacePosition[1]);
	}
}
...
void COglSurface::setBrowserSurfaceSizeAndPosition()
{
	...
	if (_browserEnabled)
	{
		...
		if (_browserWidth<128+2+4+HIERARCHY_SCROLLBAR_WIDTH)
			_browserWidth=128+2+4+HIERARCHY_SCROLLBAR_WIDTH;
		App::ct->browser->setRenderingSizeAndPosition(_browserWidth-BROWSER_HIERARCHY_MAIN_RENDERING_WINDOW_SEPARATION_WIDTH+1,surfaceSize[1]-BROWSER_HIERARCHY_TITLE_BAR_HEIGHT-1-1,surfacePosition[0]+0,surfacePosition[1]);
	}
}
