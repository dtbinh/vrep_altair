...
#define IDSN_DONE_COLLIDING_NODES_VS_TOTAL "Done. Colliding nodes: "
...
#define IDS__POSITION_CONTROL_  "(position control)"
#define IDS__VELOCITY_FORCE_TORQUE_CONTROL_ "(velocity, force/torque control)"
