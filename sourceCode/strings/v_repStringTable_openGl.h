...
#define IDSOGL_SPHERICAL "spherical"

#define IDSOGL_ZOOMING_IN "Zooming in"
#define IDSOGL_ZOOMING_OUT "Zooming out"
#define IDSOGL_SETTING_PROPORTIONS_TO_1_1 "Setting proportions to 1:1"
